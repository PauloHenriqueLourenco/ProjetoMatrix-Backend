...
public class CalculadoraSalario {
	...
	public BigDecimal getSalarioLiquido(BigDecimal salarioBruto, BigDecimal percentualImpostoINSS) {
		...
		BigDecimal salarioLiquido = salarioBruto.subtract(
				salarioBruto.multiply(percentualImpostoINSS).divide(new BigDecimal("100"), BigDecimal.ROUND_HALF_UP));
	...
	public BigDecimal getValorINSS(BigDecimal salarioBruto) {
		...
		BigDecimal valorINSS = salarioBruto.multiply(percentualINSS).divide(new BigDecimal("100"),
